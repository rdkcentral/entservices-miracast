...
############################
# Build entservices-miracast
echo "building entservices-miracast"

cd ${GITHUB_WORKSPACE}
cmake -G Ninja -S "$GITHUB_WORKSPACE" -B build/entservices-miracast \
-DUSE_THUNDER_R4=ON \
...
cmake --build build/entservices-miracast --target install
echo "======================================================================================"
exit 0
